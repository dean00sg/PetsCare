...
class EditPetProfileScreen extends StatefulWidget {
  ...
  const EditPetProfileScreen({super.key, required this.petProfile});
...
class _EditPetProfileScreenState extends State<EditPetProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocListener<PetProfileBloc, PetProfileState>(
        listener: (context, state) {
          if (state is PetProfileUpdated) {
            // เมื่อการอัปเดตโปรไฟล์สำเร็จ ให้ย้อนกลับไปหน้าก่อนหน้า
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          onTap: () async {
                            ...
                            if (pickedDate != null) {
                              setState(() {
                                _birthDate = pickedDate.toIso8601String().split('T').first; 
                                _birthDateController.text = _birthDate;
                              });
                            }
                          },
